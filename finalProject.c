        ...
        while (!user3) {
            ...
            if(shirtSize == 'q'){
                ...
                if(recipt == true) {
                    ...
                    if((receiptFile = fopen("/Users/noahholt/Desktop/Coding/C/CS2060/iteration/iteration/iteration/receipt.txt", "w")) == NULL) {
...
bool getCardNum(void) {
    ...
    while(!isValid) {
        ...
        /*if(fullCard[strlen(fullCard)-1] == '\n') {
            fullCard[strlen(fullCard)-1] = '\0';
        }*/
...
void adminPrintOrgs(FundOrg **headPtr) {
    ...
    if((tShirtFunds = fopen("/Users/noahholt/Desktop/Coding/C/CS2060/iteration/iteration/iteration/tshirtfunds.txt", "w")) == NULL) {
        puts("File could not be opened");
    } else {
